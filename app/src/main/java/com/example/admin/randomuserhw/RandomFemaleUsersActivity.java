...
public class RandomFemaleUsersActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_random_female_users);
        RecyclerView.LayoutManager layoutManager = new LinearLayoutManager(this);

        recyclerView = findViewById(R.id.rvMainFemale);
        ...
        new Thread(new Runnable() {
            @Override
            public void run() {
                RetrofitHelper.getRandomFemaleUsers()
